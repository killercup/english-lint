...
With that in mind, let’s learn about lifetimes.";
    ...
    assert_eq!(lint(text), vec![
        Hint { group: Some("adverbs"), value: "many", line: Some(3), start: 74, end: 78 },
        Hint { group: Some("adverbs"), value: "many", line: Some(5), start: 63, end: 67 },
        Hint { group: Some("weakens"), value: "things", line: Some(5), start: 429, end: 435 },
    ]);
}
...
This chapter consists of relatively independent tutorials which show you how to take your Rust to the next level. Common patterns and standard library features will be introduced. Read these sections in any order of your choosing.";
    ...
    assert_eq!(lint(text), vec![
        Hint { group: Some("adverbs"), value: "relatively", line: Some(3), start: 25, end: 35 },
    ]);
}
